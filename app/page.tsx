    ...
    <Home>
        <div className="columnaGralHome">
                ...
                <Fade duration={7000}>
                    <div className="columna4">
                        <h2 className="h22">
                                Es un honor darle la bienvenida a mi despacho legal.
                        </h2>
                        <h2 className="h22">
                                Soy Adrián Gustavo Guidi, abogado comprometido con la asesoría legal de calidad y el servicio a la comunidad.
                        </h2>
                        <h2 className="h22">

...
import { Button, Breadcrumbs, BreadcrumbItem, Card, CardHeader } from "@nextui-org/react";
          ...
          <div className="contenedorProfile">         
            ...
            <Card className="card py-4">
              <CardHeader className="pb-0 pt-2 px-4 flex-col items-start">
                ...
                <h4 className="font-bold text-large">Martes, Miercoles y Jueves de 17 a 20hs</h4>
              </CardHeader>
            </Card>
          </div>
        </Home>
